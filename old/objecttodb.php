...
//echo $word;
    ...
    VALUES (
    NULL, '".$userWordPointer."', '".$userWordGuesser."', '".$str_json2['word']."', '".$str_json2['initialLives']."', '".$str_json2['lives']."', '".$str_json2['len']."', '".$str_json2['currentWord']."', '".$str_json2['numPic']."', '".$str_json2['chgPicIndicator']."'
    )";
